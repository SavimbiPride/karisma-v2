    ...
    <div className="overflow-hidden">
      <div className="relative pt-36 min-h-screen">
        ...
        <div className="relative z-20 container mx-auto pl-40">
          ...
          <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-lg text-lg flex items-center justify-center tracking-wide transition-colors mt-8">
            WEBINAR REGULER
          </button>
            ...
            <div className="bg-white  w-full py-35 pl-32  rounded-lg ">
              <div className="flex flex-row justify-between ">
                <div className="flex flex-col items-baseline  ">
                  <h1 className=" text-[70px] font-semibold text-[#000045]">
                    Lets <span className="text-[#FFC300]">Join</span> !
                  </h1>
                  <p className="text-[20px] pt-10 w-[380px] font-semibold opacity-70 leading-[25px]">
                    Ambil langkah pertama menuju peningkatan keterampilan dan
                    pengetahuan Anda. Jangan lewatkan kesempatan emas ini, Ayo
                    gabung kursus sekarang dan raih masa depan cerah!
                  </p>
                  <button
                    onClick={() => navigate("/login")}
                    className=" bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-3 px-8 rounded-2xl text-lg  tracking-wide transition-colors mt-12 cursor-pointer "
                  >
                    Lebih Lengkap
                  </button>
                </div>
                <div className=" w-[593px] h-[494px]">
                  <img
                    src={GambarOrang}
                    alt="Orang"
